...
export const PLANTS: Record<PlantType, PlantConfig> = {
  ...
  xiaohainuo: {
    ...
    desc: '以高耐久抵挡 A87', quote: '它在网上冲浪的头像都很相似', accent: 0x50d7ce,
  },
  xinqiuyi: {
    type: 'xinqiuyi', name: '心球仪', role: '共鸣爆破', cost: 150, cooldown: 24000,
    hp: 999, behavior: 'bomb', texture: TEX.PLANT_XINQIUYI,
    desc: '短暂蓄力后造成 3×3 范围爆炸', quote: '阳光开朗，但容易爆炸', accent: 0xff5a91,
    attackDamage: 1500,
  },
  bella: {
    type: 'bella', name: '贝拉', role: '锤击变阵', cost: 150, cooldown: 10000,
    hp: 1000, behavior: 'bella', texture: TEX.PLANT_BELLA, portrait: TEX.PORTRAIT_BELLA,
    desc: '远投锤子；近敌时化为地雷；在场时贝极星产量加倍', quote: 'Asoul的队长以及武道担当，Bellllla！', accent: 0xe54955,
    attackInterval: 2700, attackDamage: 102, projectile: TEX.HAMMER,
  },
  eileen: {
    type: 'eileen', name: '乃琳', role: '穿透变阵', cost: 150, cooldown: 10000,
    hp: 300, behavior: 'eileen', texture: TEX.PLANT_EILEEN, portrait: TEX.PORTRAIT_EILEEN,
    desc: '远程穿透；近敌时化为番茄牛肉汤（仅车碾可毁）；每个在场乃琳使奶淇琳奶油概率+15%', quote: '冬嘎西嘎哈密嘎，关注乃琳多谢啦~（粤语）', accent: 0x9b72e8,
    attackInterval: 1500, attackDamage: 32, projectile: TEX.BEAM,
  },
  diana: {
    type: 'diana', name: '嘉然', role: '距离机枪', cost: 200, cooldown: 10000,
    hp: 300, behavior: 'rapid', texture: TEX.PLANT_DIANA, portrait: TEX.PORTRAIT_DIANA,
    desc: '一次连发3发糖果；敌人越近攻速越快，一格内提升至 5 倍；在场时嘉心糖半价、生命翻倍、攻击+50%', quote: '枝江最甜甜甜的小草莓！', accent: 0xff9b55,
  ...
  gladys: {
    ...
    hp: 300, behavior: 'freeze', texture: TEX.PLANT_GLADYS, portrait: TEX.PORTRAIT_GLADYS,
    desc: '冰冻全场；概率留下心宜或小海诺', quote: '铁柱铁柱，歌舞突出', accent: 0x54c8ff,
    freezeDuration: 4000,
  },
  fiona: {
    type: 'fiona', name: '心宜', role: '概率支援', cost: 250, cooldown: 20000,
    hp: 300, behavior: 'squash', texture: TEX.PLANT_FIONA, portrait: TEX.PORTRAIT_FIONA,
    desc: '压扁敌人；概率留下思诺或心球仪', quote: '不交电费，谢谢', accent: 0xff6fba,
    attackDamage: 999,
  },
  xingkongtang: {
    type: 'xingkongtang', name: '星空糖', role: '星糖融合射手', cost: 0, cooldown: 0,
    hp: 1000, behavior: 'lifesteal', texture: TEX.PLANT_XINGKONGTANG, portrait: TEX.PORTRAIT_XINGKONGTANG,
    desc: '贝极星＋嘉心糖；吸血并有 30% 概率造成 3 倍伤害', quote: '有人知道超级嘉贝的下一句是什么吗', accent: 0xffd44f,
    attackInterval: 1000, attackDamage: 30, projectile: TEX.STAR_CANDY,
  },
  xilanai: {
    type: 'xilanai', name: '喜拉乃', role: '星巧融合投手', cost: 0, cooldown: 0,
    hp: 1000, behavior: 'sunlobber', texture: TEX.PLANT_XILANAI, portrait: TEX.PORTRAIT_XILANAI,
    desc: '贝极星＋奶淇琳；产阳光并投掷星形巧克力', quote: '喜拉乃会自己找糖吃', accent: 0xf4c25e,
  ...
  jiaxinnaitang: {
    ...
    hp: 300, behavior: 'burstlobber', texture: TEX.PLANT_JIAXINNAITANG, portrait: TEX.PORTRAIT_JIAXINNAITANG,
    desc: '奶淇琳＋嘉心糖；冰淇淋主弹炸出 8 枚糖果', quote: '爆了爆了！', accent: 0xffa6bc,
    attackInterval: 2000, attackDamage: 40, projectile: TEX.CANDY_ICE_CREAM,
  },
  yigehun: {
    type: 'yigehun', name: '一个魂', role: '三重削弱射手', cost: 0, cooldown: 0,
    hp: 1500, behavior: 'soulshooter', texture: TEX.PLANT_YIGEHUN, portrait: TEX.PORTRAIT_YIGEHUN,
    desc: '三重融合；命中叠加减速与降攻，最多 3 层', quote: '它总是念叨着十以内加减法', accent: 0xb594ff,
