...
export const RELICS: Record<RelicId, RelicConfig> = {
  ...
  'xiaomi-keyboard': {
    id: 'xiaomi-keyboard', name: '小爱联名键盘', glyph: '⌨️', iconTexture: TEX.RELIC_XIAOMI_KEYBOARD, rarity: 'a',
    allowedTypes: null,
    effects: { hpMultiplier: 2.0 },
    quote: '小爱同学，随时待命。',
  },
  'pointer-01': {
    id: 'pointer-01', name: '01指针', glyph: '🖱️', iconTexture: TEX.RELIC_POINTER_01, rarity: 'a',
    allowedTypes: ['xingkongtang', 'xilanai', 'jiaxinnaitang'],
    effects: { attackSpeedMultiplier: 2.0, damageMultiplier: 1.5 },
    quote: '01 号指针，指哪打哪。',
  },
  'wish-ticket-a': {
    id: 'wish-ticket-a', name: '愿望券A', glyph: '🎟️', iconTexture: TEX.RELIC_WISH_TICKET_A, rarity: 'a',
    allowedTypes: ['eileen'],
    effects: {
  ...
  'wish-ticket-b': {
    id: 'wish-ticket-b', name: '愿望券B', glyph: '🎟️', iconTexture: TEX.RELIC_WISH_TICKET_B, rarity: 'a',
    allowedTypes: ['bella'],
    effects: {
  ...
  'fan-cheerstick': {
    id: 'fan-cheerstick', name: 'Asoul应援棒', glyph: '🎇', iconTexture: TEX.RELIC_FAN_CHEERSTICK, rarity: 'b',
    allowedTypes: null,
    effects: { attackSpeedMultiplier: 1.5 },
    quote: '为整个 A-SOUL 应援。',
  },
  'tour-ticket': {
    id: 'tour-ticket', name: '线下演出门票', glyph: '🎫', iconTexture: TEX.RELIC_TOUR_TICKET, rarity: 'b',
    allowedTypes: null,
  ...
  'keyboard-200': {
    id: 'keyboard-200', name: '200块的键盘', glyph: '⌨️', iconTexture: TEX.RELIC_KEYBOARD_200, rarity: 'c',
    allowedTypes: null,
    effects: { hpMultiplier: 1.3 },
    quote: '性价比之选。',
  },
  'beijixing-weekly': {
    id: 'beijixing-weekly', name: '贝极星周报', glyph: '📰', iconTexture: TEX.RELIC_BEIJIXING_WEEKLY, rarity: 'c',
    allowedTypes: ['beijixing'],
    effects: { produceBonus: 15, hpMultiplier: 2.0 },
    quote: '贝极星 trend，周周更新。',
  },
  'naiqilin-weekly': {
    id: 'naiqilin-weekly', name: '奶淇琳周报', glyph: '📰', iconTexture: TEX.RELIC_NAIQILIN_WEEKLY, rarity: 'c',
    allowedTypes: ['naiqilin'],
    effects: { attackSpeedMultiplier: 1.3, creamStunMultiplier: 2.0 },
    quote: '奶淇琳速报，甜度超标。',
  },
  'jiaxintang-weekly': {
    id: 'jiaxintang-weekly', name: '嘉心糖周报', glyph: '📰', iconTexture: TEX.RELIC_JIAXINTANG_WEEKLY, rarity: 'c',
    allowedTypes: ['jiaxintang'],
    effects: { damageMultiplier: 1.3, extraShots: 1 },
    quote: '嘉心糖快讯，糖分拉满。',
  },
  'minus-8000-mic': {
    id: 'minus-8000-mic', name: '-8000麦克风', glyph: '🎙️', iconTexture: TEX.RELIC_MINUS_8000_MIC, rarity: 'd',
    allowedTypes: null,
    effects: { damageMultiplier: 1.3, costMultiplier: 1.3 },
    quote: '声音大，代价也大。',
  },
  'keyboard-20': {
    id: 'keyboard-20', name: '20块的键盘', glyph: '⌨️', iconTexture: TEX.RELIC_KEYBOARD_20, rarity: 'd',
    allowedTypes: null,
    effects: { hpMultiplier: 1.3, costMultiplier: 1.3 },
    quote: '便宜货，但能用。',
  },
  'mountain-speaker': {
    id: 'mountain-speaker', name: '群山纹理音响', glyph: '🔊', iconTexture: TEX.RELIC_MOUNTAIN_SPEAKER, rarity: 'd',
    allowedTypes: null,
