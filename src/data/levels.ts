...
export const ALL_LEVELS: LevelConfig[] = [
  ...
  },
  {
    ...
    waves: [
      ...
      wave(9500, '梯子试爬', [spawn('basic', 4, 1900), spawn('ladder', 3, 3000)], true),
  ...
  },
  {
    ...
    waves: [
      ...
      wave(9500, '气球升空', [spawn('basic', 5, 1700), spawn('balloon', 3, 2800)], true),
      wave(11000, '空地合流', [spawn('basic', 5, 1700), spawn('screen', 2, 3000), spawn('balloon', 2, 2800)]),
  ...
  },
  {
    ...
    waves: [
      ...
      wave(9500, '骑士初阵', [spawn('basic', 5, 1700), spawn('knight', 1, 0), spawn('pole', 2, 3000)], true),
  ...
  },
  {
    ...
    waves: [
      ...
      wave(8500, '梯子接力', [spawn('basic', 4, 1600), spawn('ladder', 4, 2600)], true),
      wave(9500, '雪橇试车', [spawn('basic', 4, 1600), spawn('sled', 1, 0), spawn('knight', 1, 0)]),
      wave(11000, '三路混编', [spawn('phone', 3, 2500), spawn('screen', 3, 2700), spawn('ladder', 3, 2500)]),
  ...
  },
  {
    ...
    waves: [
      ...
      wave(8500, '地下绕后', [spawn('basic', 5, 1500), spawn('miner', 3, 3400)], true),
      wave(9500, '空地混编', [spawn('balloon', 3, 2600), spawn('ladder', 3, 2400)]),
      wave(11500, '龙骑合流', [spawn('basic', 6, 1400), spawn('balloon', 2, 3400), spawn('dragon', 1, 0)]),
  ...
  },
  {
    ...
    waves: [
      ...
      wave(8000, '梯子乱入', [spawn('basic', 5, 1500), spawn('ladder', 5, 2300)], true),
      wave(9000, '车辆与矿工', [spawn('basic', 4, 1500), spawn('sled', 1, 0), spawn('miner', 3, 3400)]),
      wave(10500, '化龙彩排', [spawn('phone', 3, 2400), spawn('balloon', 3, 2200), spawn('dragon', 1, 0)]),
  ...
  },
  {
    ...
    waves: [
      ...
      wave(7500, '黑化骑士团', [spawn('basic', 5, 1500), spawn('knight', 3, 3300)], true),
